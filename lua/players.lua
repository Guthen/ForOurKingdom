...
function Players:Load()
    ...
    self.P1.x = 4
    self.P1.y = 0
    self.P1.units = {"greu", "grus", "grea", "goblex", "goblattack", "rockpose", "roco", "slapher", "norber"}
    self.P1.curUnit = 1
    ...
    self.P2.x = 35
    self.P2.y = 0
    self.P2.units = {"greu", "grus", "grea", "goblex", "goblattack", "rockpose", "roco", "slapher", "norber"}
    self.P2.curUnit = 1
